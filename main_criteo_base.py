...
def get_model(
    ...
    if name == "fm":
        ...
        return FMFRNet(field_dims, embed_dim, num_layers=1, weight_type="bit", att_size=10, mlp_layer=256)
    elif name == "fmfrnet_vec":
        return FMFRNet(field_dims, embed_dim, num_layers=1, weight_type="vector", att_size=10, mlp_layer=256)
    else:
...
def main(dataset_name,
    ...
    field_dims, trainLoader, validLoader, testLoader = \
        get_criteo_dataset_loader_valid(batch_size=batch_size)
    print(field_dims)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='chkpt_criteo')
